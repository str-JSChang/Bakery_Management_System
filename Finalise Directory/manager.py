from main import validate_email, check_password_strength
...
def add_new_user():
    ...
    while True:
        try:
            ...
            if choice == 1:
                from main import register_customer
                register_customer()
            elif choice == 2:
                from main import register_staff
                register_staff()
            elif choice == 3:
                return
            else:
    ...
    try:
        ...
        while i < len(lines):
            ...
            if user[2] == username:
                ...
                print(f"Name: {user[0]}, Username: {user[2]}, Email: {user[1]}, Role: {user[4]}")
                ...
                if new_password != "":
                    ...
                    if new_password != confirm_password:
                        ...
                        print("Password is not strong enough. Password not updated.")
                        new_password = ""
                    else:
                ...
                user[2] = new_username if new_username else user[2]
                user[3] = new_password if new_password else user[3]
